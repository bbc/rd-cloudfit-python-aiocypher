...
provided configuration runs the tests in `python3.6`, but other
configurations are possible. The default test command will discover
all tests in the `tests` directory and run them.
